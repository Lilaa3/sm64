...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		WARP_NODE(0x03, LEVEL_BOB, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BLACK_BOBOMB, 0, 80, -409, 0, 0, 0, (0x01 << 24) | (WARP_NODE_03 << 16), bhvDoorWarp),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(MODEL_BLACK_BOBOMB, 0, 80, -400, 0, 0, 0, (0x01 << 24) | (WARP_NODE_03 << 16), bhvDoorWarp),
		OBJECT(MODEL_NONE, 0, 80, 0, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
	...
	AREA(3, bob_area_3),
		...
		WARP_NODE(0xF0, LEVEL_CASTLE, 0x01, 0x32, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x03, LEVEL_BOB, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BLACK_BOBOMB, 0, 80, -400, 0, 0, 0, (0x01 << 24) | (WARP_NODE_03 << 16), bhvDoorWarp),
		OBJECT(MODEL_NONE, 0, 80, 0, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
